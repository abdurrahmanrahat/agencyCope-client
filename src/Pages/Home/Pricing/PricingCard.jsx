  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <h2 className="text-4xl font-medium text-white">{price}</h2>
        <p className="text-gray-300 mt-1 mb-5">{subtitle}</p>

        <h3 className="text-xl font-semibold text-[#B3D335] mb-4">{title}</h3>
