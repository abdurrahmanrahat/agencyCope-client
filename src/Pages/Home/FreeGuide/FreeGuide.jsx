...
const FreeGuide = () => {
  ...
  return (
    <div className="my-20 md:flex gap-12 mx-4 md:mx-0">
      {/* gif image */}
      ...
      <div className="md:w-1/2 flex flex-col justify-evenly gap-y-2 md:gap-y-0">
        <h4 className="font-bold text-[#EE9322] text-[18px]">FREE GUIDE</h4>
        ...
        <div className="flex flex-col gap-y-1">
          <div className="flex gap-3">
            <IoMdCheckboxOutline className="text-[#EE9322] font-bold text-[40px] md:text-[30px]" />
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex items-center justify-center mt-4">
            <button
              type="submit"
              className="w-[100%] bg-[#EE9322] py-2 text-[16px] text-white font-[600] uppercase"
            >
              Get Instant Access
            </button>
          </div>
