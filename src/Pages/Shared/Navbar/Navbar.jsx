...
const Navbar = () => {
  ...
  return (
    <div className="bg-dark text-white">
      <div className="container-class flex items-center justify-between py-2 ">
        <div className="p-4">
          <img src={Logo} className="w-40 h-18 rounded" alt="" />
        </div>

        <div className="hidden md:block">
          <ul className="flex flex-col md:flex-row items-center justify-center gap-3 font-medium">
            <li>
