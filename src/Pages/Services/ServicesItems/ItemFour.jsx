...
import Image from "../../../assets/services/services-four.png";

const ItemFour = () => {
  return (
    <div className="mx-4 lg:mx-0 mt-24" id="item-four">
      <div className="text-center">
        <h2 className="text-[28px] font-medium">01. DIGITAL MARKETING</h2>
