        ...
        <div className="mx-4 lg:mx-0 py-16" id="item-two">
          <div className="text-center">
            ...
            <p className="md:text-[18px] md:px-28">
              Get your website up and running fast, without compromising any of
              the quality. Websites need to do more than just look pretty. With
              Website In A Day, you will get a website that is equal parts
              strategy, design, and technical genius for a fully functional
              experience made to captivate and convert. Looking for a completely
              customized and coded website? Let’s chat!
            </p>
          </div>
          ...
          <div className="mt-12 md:flex gap-12">
            ...
            <div className="md:w-1/2 text-[18px] flex flex-col justify-evenly gap-y-3">
              ...
              <div>
                <p>
                  <span className="font-medium">Timeframe:</span> 3 days (24
                  hours for design)
                </p>
                <p>
